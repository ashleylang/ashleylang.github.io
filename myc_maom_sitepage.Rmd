...
## What controls the distribution of POM vs MAOM C  in forest soil?

## Quick Summary
### *Recent studies indicate that ecosystems dominated by vegetation associated with AM fungi store more soil organic matter (SOM) as mineral-associated organic matter (MAOM) rather than particulate organic matter (POM), but plant mycorrhizal associations are often correlated with plant litter chemistry. We sought to disentangle these potential drivers of MAOM content in forests across New Hampshire and Vermont.*  
...
gg_inset_map1 = ggdraw() +
  ...
  draw_plot(regionalmap, x = 0.5, y = 0.7, width = 0.3, height = 0.3)
...
### We tested how mycorrhizal associations, foliar chemistry, and clay content affected the proportion of total soil carbon found in the MAOM vs POM, and the C:N of both the MAOM and POM  
...
```{r ModelpropC.HF, echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, include=FALSE}
...
```  
### Proportion of total C in POM is higher under trees with high foliar C:N and decreases with higher soil clay percentage.  
```{r ModelpropC.FLF, echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, fig.height=10, include=FALSE}
...
```{r figure_propC, echo=FALSE, warning=FALSE, message=FALSE, fig.width=20, fig.height=20}
...
### POM C:N tracks foliar C:N (this is likely because it still *is* basically litter... and no effect of mycorrhizal type on POM C:N is evidence that our study design was effective!)   
```{r CN_POM,  echo=FALSE, warning=FALSE, message=FALSE, fig.width=10, include=FALSE}
...
```{r fig4, echo=FALSE, warning=FALSE, message=FALSE, fig.width=20, fig.height=20}
