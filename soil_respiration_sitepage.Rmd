...
```{r soilchars, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Soil Characteristics', out.width='75%', fig.pos='H'}
knitr::include_graphics("~/Documents/Website/ashleylang.github.io/images/soil chars.pdf")
```
