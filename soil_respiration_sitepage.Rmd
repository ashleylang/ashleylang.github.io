...
```{r soilchars, echo = FALSE, message=FALSE, fig.align='center', fig.cap='Soil Characteristics', out.width='0.75\\linewidth', fig.pos='H'}
knitr::include_graphics("soil chars.pdf")
```
