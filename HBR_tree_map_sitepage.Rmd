---
title: "Dominant tree species in valley-wide plots at Hubbard Brook Experimental Forest, Woodstock, NH."
...
regionalmap=ggplot(data=nh)+
  ...
  theme(axis.text=element_blank(), axis.line = element_blank(), axis.ticks=element_blank(), axis.title=element_blank())+
    geom_text(x=-71.75, y=43.93, label="*", size=12)
...
closeUpmap=ggplot(data=nh)+
  ...
  geom_point(aes(x = x, y = y, colour=Species), data = plots, size = 3)+
